...
function ProjectsPageContent() {
  ...
  const [projects, setProjects] = useLocalStorage<Project[]>('ai-playground-projects', []);
              ...
              <div className="lg:col-span-2">
                ...
                <div className="space-y-4">
                  {projects.map((project: Project) => {
                    const totalExamples = project.datasets.reduce((sum: number, dataset) => sum + dataset.examples.length, 0);
