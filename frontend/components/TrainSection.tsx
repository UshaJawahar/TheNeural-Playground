  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
        <h3 className="text-xl font-semibold text-black mb-4">Progress</h3>
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <span className="text-black font-medium">Labels: {project.datasets.length}/2</span>
          ...
          <div>
            <span className="text-black font-medium">Examples: {project.datasets.reduce((sum, d) => sum + d.examples.length, 0)}/4</span>
            <div className="w-full bg-blue-200 rounded-full h-3 mt-2">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6">
        <h3 className="text-xl font-semibold text-black mb-4">Add New Label</h3>
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 border border-gray-300 rounded-xl text-black placeholder-gray-500"
      ...
      {project.datasets.length > 0 && (
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-black">Your Dataset</h3>
          {project.datasets.map((dataset) => (
            <div key={dataset.id} className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="bg-blue-500 p-6 text-white">
                <div className="flex items-center justify-between">
                  <h4 className="text-xl font-bold text-white">{dataset.label}</h4>
                  <button
