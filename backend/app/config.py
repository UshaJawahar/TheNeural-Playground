...
class Settings(BaseSettings):
    # GCP Configuration
    google_cloud_project: str = Field(default="theneural", env="GOOGLE_CLOUD_PROJECT")
    ...
    # CORS Configuration
    cors_origin: str = Field(default="https://playground-neural-107731139870.us-central1.run.app", env="CORS_ORIGIN")
